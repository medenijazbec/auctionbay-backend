...
namespace auctionbay_backend.Controllers
{
    ...
    public class ProfileController : ControllerBase
    {
        ...
        public ProfileController(UserManager<ApplicationUser> userManager, IAuctionService auctionService)
        {
        ...
        [HttpPut("auction/{id}")]
        public async Task<IActionResult> UpdateAuction([FromRoute] int id, [FromBody] AuctionUpdateDto dto)
        {
            var user = await _userManager.FindByNameAsync(User.Identity.Name);
            if (user == null)
                return Unauthorized();
